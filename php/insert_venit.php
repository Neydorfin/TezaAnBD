    ...
    <body>
        ...
        <div class="login_form">
            <form action="" method="POST" >
                <input type="hidden" id="action" value="insert_venit">
                <h2>Insert</h2>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <?php 
                            $sql = mysqli_query ($conn, "SELECT * FROM obj_venit");

                            while ($result = mysqli_fetch_array($sql)){
                            echo ' <option value="'.$result['id_obj_venit'].'">'.ucwords($result['obj_venit']).'</option>';
                            }?>
                        </select>
                    </li>
                    <li>
